...
int main()
{
    ...
    */
    ...
    // Ademas ahora el numero random se coloco fuera del bucle para generar un solo numero random y no varios, esto resulta en una mayor probabilidad de adivinar
    ...
    */
    ...
    cin.get(); //Evita que se cierre la consola despues del return
    //se reemplazo system("pause") de windows por cin.get() para hacer el codigo mas portable
}